...
Secrets stored here: Access service-token client secret, enrolment JWT.
 *
 * WHY THIS EXISTS
 * ---------------
...
class SecretStore(context: Context) {
    ...
    private val prefs =
        context.getSharedPreferences("soildtunnel_secrets", Context.MODE_PRIVATE)
    ...
    companion object {
        ...
        private const val KEY_ALIAS = "soildtunnel_secret_v1"

package com.soildtunnel.desktop.model
...
data class ConnectionProfile(
     ...
     * in-app proxy bridge (see [com.soildtunnel.desktop.core.ShareBridge]).
     ...
     * argument (argv is world-readable via /proc) — it is handed to the engine

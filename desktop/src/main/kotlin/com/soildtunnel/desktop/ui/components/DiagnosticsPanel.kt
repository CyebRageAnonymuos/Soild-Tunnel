...
import com.soildtunnel.desktop.core.CheckState
import com.soildtunnel.desktop.core.ComponentCheck
import com.soildtunnel.desktop.core.Diagnostics
import com.soildtunnel.desktop.core.DiagnosticsLog
import com.soildtunnel.desktop.core.LogLevel
import com.soildtunnel.desktop.core.LogLine
...
private data class Overall(val color: Color, val captionKey: String)

private fun overallState(checks: List<ComponentCheck>): Overall = when {
    checks.isEmpty() -> Overall(Color(0xFF8A93A6), "diag_idle")
    checks.any { it.state == CheckState.FAIL } -> Overall(Color(0xFFFF5C7A), "diag_problem")
    checks.all { it.state == CheckState.PASS } -> Overall(Color(0xFF32E0C4), "diag_all_ok")
    else -> Overall(Color(0xFFF5C451), "diag_idle")
}

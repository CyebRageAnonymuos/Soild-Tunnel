...
Config files:
  --config <path>          base identity config path (default soildtunnel.toml)
...
pub fn parse_args(args: Vec<String>) -> crate::error::Result<()> {
    ...
    while i < args.len() {
        ...
        macro_rules! next_value {
            () => {{
                ...
                args.get(i).ok_or_else(|| {
                    crate::error::SoildTunnelError::Other(format!("{arg} requires a value"))
                })?
            }};
        }
        ...
        match arg {
            "-v" | "--version" => {
                println!("soildtunnel {}", env!("CARGO_PKG_VERSION"));
                std::process::exit(0);
            }
            ...
            "--bind" => set("SOILDTUNNEL_SOCKS", next_value!()),
            "--http-proxy" => set("SOILDTUNNEL_HTTP_PROXY", next_value!()),
            "--upstream" => set("SOILDTUNNEL_UPSTREAM", next_value!()),
            "--quick-reconnect" => set("SOILDTUNNEL_QUICK_RECONNECT", "1"),
            "--no-quick-reconnect" => set("SOILDTUNNEL_QUICK_RECONNECT", "0"),

            "-4" => set("SOILDTUNNEL_IP", "v4"),
            "-6" => set("SOILDTUNNEL_IP", "v6"),
            "--dual" => set("SOILDTUNNEL_IP", "both"),
            "--ip" => set("SOILDTUNNEL_IP", next_value!()),

            "--peer" => set("SOILDTUNNEL_PEER", next_value!()),
            "--wg-peer" => set("SOILDTUNNEL_WG_PEER", next_value!()),
            ...
            "--turbo" => set("SOILDTUNNEL_SCAN", "turbo"),
            "--balanced" => set("SOILDTUNNEL_SCAN", "balanced"),
            "--thorough" => set("SOILDTUNNEL_SCAN", "thorough"),
            "--stealth" => set("SOILDTUNNEL_SCAN", "stealth"),
            "--ironclad" => set("SOILDTUNNEL_SCAN", "ironclad"),

            "--noize" => set("SOILDTUNNEL_NOIZE", next_value!()),

            "--h2" | "--http2" => set("SOILDTUNNEL_MASQUE_HTTP2", "1"),
            "--h2-peer" => set("SOILDTUNNEL_MASQUE_H2_PEER", next_value!()),
            "--ech" => set("SOILDTUNNEL_ECH", next_value!()),
            "--no-data-check" => {
                set("SOILDTUNNEL_MASQUE_NO_DATA_CHECK", "1");
                set("SOILDTUNNEL_WG_NO_DATA_CHECK", "1");
            }
            "--validate-secs" => {
                let value = next_value!().clone();
                set("SOILDTUNNEL_MASQUE_VALIDATE_SECS", &value);
                set("SOILDTUNNEL_WG_VALIDATE_SECS", &value);
            }
            "--startup-secs" => set("SOILDTUNNEL_MASQUE_STARTUP_SECS", next_value!()),
            "--reconnect-secs" => {
                let value = next_value!().clone();
                set("SOILDTUNNEL_MASQUE_RECONNECT_SECS", &value);
                set("SOILDTUNNEL_WG_RECONNECT_SECS", &value);
            }
            "--dns" => set("SOILDTUNNEL_DNS", next_value!()),
            "--fragment" => set("SOILDTUNNEL_MASQUE_H2_FRAGMENT", "1"),
            "--fragment-size" => set("SOILDTUNNEL_MASQUE_H2_FRAGMENT_SIZE", next_value!()),
            "--fragment-delay" => set("SOILDTUNNEL_MASQUE_H2_FRAGMENT_DELAY", next_value!()),

            "--keepalive" => set("SOILDTUNNEL_WG_KEEPALIVE", next_value!()),
            "--no-profile-retry" => set("SOILDTUNNEL_WG_NO_PROFILE_RETRY", "1"),

            "--config" => set("SOILDTUNNEL_CONFIG", next_value!()),
            "--wg-config" => set("SOILDTUNNEL_WG_CONFIG", next_value!()),
            "--masque-config" => set("SOILDTUNNEL_MASQUE_CONFIG", next_value!()),

            "--team" | "--organization" => set("SOILDTUNNEL_TEAM", next_value!()),
            "--access-id" => set("SOILDTUNNEL_ACCESS_CLIENT_ID", next_value!()),
            "--access-secret" => set("SOILDTUNNEL_ACCESS_CLIENT_SECRET", next_value!()),
            "--access-token" => set("SOILDTUNNEL_ACCESS_TOKEN", next_value!()),
            "--access-email" => set("SOILDTUNNEL_ACCESS_EMAIL", next_value!()),
            "--gateway" => set("SOILDTUNNEL_GATEWAY", "1"),

            "--route-block" => set("SOILDTUNNEL_ROUTE_BLOCK", next_value!()),
            "--route-direct" => set("SOILDTUNNEL_ROUTE_DIRECT", next_value!()),
            "--routes" => set("SOILDTUNNEL_ROUTES_FILE", next_value!()),

            "--tls-groups" => set("SOILDTUNNEL_TLS_GROUPS", next_value!()),
            "--perf" => set("SOILDTUNNEL_PERF_PROFILE", next_value!()),
            "--log-level" => set("SOILDTUNNEL_LOG_LEVEL", next_value!()),
            "--verbose" => set("SOILDTUNNEL_LOG_LEVEL", "debug"),

            other => {
                return Err(crate::error::SoildTunnelError::Other(format!(
